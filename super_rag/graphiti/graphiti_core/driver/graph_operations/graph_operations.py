...
class GraphOperationsInterface(BaseModel):
    ...
    Type reference:
        - driver: GraphDriver
        - EntityNode, EpisodicNode, CommunityNode, SagaNode from super_rag.graphiti.graphiti_core.nodes
        - EntityEdge, EpisodicEdge, CommunityEdge from super_rag.graphiti.graphiti_core.edges
        - EpisodeType from super_rag.graphiti.graphiti_core.nodes
    """
