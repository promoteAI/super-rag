...
mcp_server = FastMCP("SuperRAG")

# Base URL for internal API calls
API_BASE_URL = settings.super_rag_mcp_url
...
# Add a resource for Super RAG usage information
# Use https URL form so Pydantic AnyUrl validation accepts it (custom schemes can fail)
@mcp_server.resource("https://super-rag.local/usage-guide")
...
def get_api_key() -> str:
    ...
    2. SUPER_RAG_API_KEY environment variable
    ...
    api_key = os.getenv("SUPER_RAG_API_KEY")
